...
/// @dev Timestamp of the first Saturday evening, 20:00, in UTC seconds since the Unix Epoch. It's
///   used to align the allowed drawing windows with Saturday evenings.
...
library Drawing {
  ...
  /// @return bool True iff a drawing window is ongoing.
